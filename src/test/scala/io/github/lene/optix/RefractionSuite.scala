...
import io.github.lene.optix.ColorConstants.BLUE_TINTED_GLASS
import io.github.lene.optix.ColorConstants.GREEN_TINTED_GLASS
import io.github.lene.optix.ColorConstants.HIGHLY_TRANSPARENT_GRAY
import io.github.lene.optix.ColorConstants.HIGHLY_TRANSPARENT_WHITE
import io.github.lene.optix.ColorConstants.RED_TINTED_GLASS
import io.github.lene.optix.ColorConstants.REFRACTION_TEST_GRAY
...
import io.github.lene.optix.ImageMatchers.showDiamondRefraction
import io.github.lene.optix.ImageMatchers.showGlassRefraction
import io.github.lene.optix.ImageMatchers.showPlaneInRegion
import io.github.lene.optix.ImageMatchers.showWaterRefraction
...
class RefractionSuite extends AnyFlatSpec
  ...
  it should "increase edge brightness with higher IOR" in:
    ...
    val imageWater = renderer.render(TEST_IMAGE_SIZE)
    ...
    val imageDiamond = renderer.render(TEST_IMAGE_SIZE)
