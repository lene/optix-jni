...
import menger.optix.ImageMatchers.haveSphereCenteredInImage
import menger.optix.ThresholdConstants.MAX_ASPECT_RATIO_4_3
import menger.optix.ThresholdConstants.MIN_ASPECT_RATIO_4_3
